programa
{
	...
	funcao inicio()
	{
		...
		suas atividades. Faça um sistema que leia o índice de poluição medido e emita a notificação 
		...
		se(indice >=0.3 e indice <0.4){
			escreva("Gruo 1 está intimado a suspender suas atividades.")
		}
		senao se (indice >= 0.4 e indice < 0.5){
			escreva("Grupo 1 e 2 estão intimados a suspender suas atividades.")
		}
		senao se (indice >=0.5){
			escreva("Todos os grupos estao intimados a suspender suas atividades.")
		}
		senao{
			escreva("Todos os grupos estao com indice aceitavel de poluição.")
		}
	}
}
/* $$$ Portugol Studio $$$ 
